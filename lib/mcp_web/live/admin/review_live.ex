defmodule McpWeb.Admin.ReviewLive do
  ...
  alias McpWeb.Admin.Underwriting.Components.TimelineComponent
  alias McpWeb.Admin.Underwriting.Components.RequestInfoModal
  alias McpWeb.Admin.Underwriting.Components.CoPilotChat
  require Ash.Query
        ...
        <div>
          ...
          <div class="flex items-center gap-2 mt-2">
            ...
            <%= if @application.sla_due_at do %>
              <div class="ml-4">
                <.live_component module={McpWeb.Admin.Underwriting.Components.SlaTimer} id="sla-timer" due_at={@application.sla_due_at} />
              </div>
            <% end %>
          </div>
        </div>
