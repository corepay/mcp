      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        <McpWeb.CoreComponents.card>
          ...
          <div class="card-actions justify-end">
            <McpWeb.CoreComponents.button variant="primary" size="sm">View Apps</McpWeb.CoreComponents.button>
          </div>
        </McpWeb.CoreComponents.card>
        ...
        <McpWeb.CoreComponents.card>
          ...
          <div class="card-actions justify-end">
            <McpWeb.CoreComponents.button variant="secondary" size="sm">Manage Keys</McpWeb.CoreComponents.button>
          </div>
        </McpWeb.CoreComponents.card>
      </div>
    </div>
