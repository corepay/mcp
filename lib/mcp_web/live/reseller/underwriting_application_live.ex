        ...
        <div class="space-y-6">
          ...
          <%= if @application.risk_assessment do %>
            <McpWeb.Core.CoreComponents.card>
              ...
              <div
                class="radial-progress text-primary mx-auto block"
                style={"--value:#{@application.risk_assessment.score}; --size:8rem;"}
              >
              ...
              <div class="mt-4">
                ...
                <p class="text-sm">
                  {@application.risk_assessment.recommendation |> to_string() |> String.capitalize()}
                </p>
              </div>
            </McpWeb.Core.CoreComponents.card>
          <% end %>
