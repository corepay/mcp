defmodule McpWeb.Tenant.ApplicationDetailLive do
    ...
    application = %{
      ...
      timeline: [
        ...
        %{
          ...
          time: DateTime.utc_now() |> DateTime.add(-100, :second)
        }
      ],
      atlas_chat: [
        %{
          sender: :ai,
          content: "Hello! I'm Atlas. How would you like to complete your application today?"
        },
        %{sender: :user, content: "Chat with Atlas"},
        %{
          sender: :ai,
          content:
            "Great choice! I'll ask you a few questions to get your business approved. First, what is the legal name of your business?"
        },
  ...
  def render(assigns) do
      ...
      <div class="flex items-center justify-between p-6 border-b border-base-200 bg-base-100">
        <div>
          ...
          <p class="text-sm text-base-content/60 mt-1">
            ID: {@application.id} • Submitted {Calendar.strftime(
      ...
      <div class="flex-1 overflow-hidden flex">
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div class="card bg-base-100 shadow-sm border border-base-200">
            <div class="card-body">
              <h3 class="card-title text-sm uppercase tracking-wider text-base-content/60">
                Risk Assessment
              </h3>
              <div class="flex items-center gap-6 mt-2">
                <div
                  class="radial-progress text-warning"
                  style={"--value:#{@application.risk_score}; --size:4rem;"}
                >
                ...
                <div>
                  ...
                  <div class="text-sm text-base-content/70">
                    Flagged for manual review due to high transaction volume estimate.
                  </div>
                </div>
              </div>
            </div>
    ...
    <!-- Application Details -->
          <div class="card bg-base-100 shadow-sm border border-base-200">
            <div class="card-body">
              <h3 class="card-title text-sm uppercase tracking-wider text-base-content/60 mb-4">
                  ...
                  <li class="step step-primary">
                    <div class="text-left">
                      ...
                      <div class="text-xs text-base-content/60">
                        {Calendar.strftime(event.time, "%I:%M %p")}
                      </div>
                    </div>
                  </li>
                <% end %>
    ...
    <!-- Sidebar (Atlas Chat History) -->
        <div class="w-96 border-l border-base-200 bg-base-50 flex flex-col">
          <div class="p-4 border-b border-base-200 font-bold flex items-center gap-2">
            <.icon name="hero-chat-bubble-left-right" class="w-5 h-5" /> Communication Log
          </div>
