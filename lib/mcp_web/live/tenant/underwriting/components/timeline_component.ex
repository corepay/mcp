defmodule McpWeb.Tenant.Underwriting.Components.TimelineComponent do
  @moduledoc """
  Component to display the timeline of underwriting activities.
  """
        ...
        <div class="relative pl-4 border-l border-base-300 space-y-6">
          <%= for activity <- @activities do %>
            <div class="relative">
              <!-- Dot -->
              <div class={[
                "absolute -left-[21px] top-1 w-3 h-3 rounded-full border-2 border-base-100",
                dot_color(activity.type)
              ]}>
              </div>
