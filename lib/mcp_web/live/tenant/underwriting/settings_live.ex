    ...
    <div class="max-w-2xl mx-auto p-6">
      ...
      >
        <div>
          ...
          <.input
            type="select"
            field={f[:preferred_vendor]}
            options={[{"ComplyCube", :comply_cube}, {"iDenfy", :idenfy}]}
            class="w-full bg-slate-900 border-slate-700 text-slate-100 rounded-md"
          />
        </div>
        ...
        <div class="flex items-center space-x-3">
          <.input
            type="checkbox"
            field={f[:circuit_breaker_enabled]}
