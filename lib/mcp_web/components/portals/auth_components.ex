    ...
    <div class="min-h-screen flex flex-col md:flex-row bg-base-200 font-sans">
      ...
      <div class="hidden md:flex md:w-1/2 relative overflow-hidden bg-base-200">
        ...
        <div class="absolute inset-0 overflow-hidden">
          <div class={["absolute -top-24 -left-24 w-96 h-96 rounded-full blur-3xl animate-pulse opacity-30", @bg_color_class]}></div>
          <div class={["absolute top-1/2 left-1/2 w-64 h-64 rounded-full blur-2xl opacity-30", @bg_color_class]}></div>
          <div class={["absolute -bottom-12 -right-12 w-80 h-80 rounded-full blur-3xl opacity-20", @bg_color_class]}></div>
        </div>
        ...
        <div class="relative z-10 flex flex-col justify-center items-start w-full h-full text-white p-16">
          ...
          <div :if={@features != []} class="mt-12 space-y-4">
            <div :for={feature <- @features} class="flex items-center gap-3 opacity-80 hover:opacity-100 transition-opacity">
      ...
      <div class="flex-1 flex flex-col justify-center items-center p-6 md:p-12 bg-base-100 relative">
        ...
        <div class={["absolute top-0 left-0 right-0 h-2 bg-gradient-to-r md:hidden", @gradient_class]}></div>

        <div class="w-full max-w-md space-y-8">
          <!-- Mobile Header -->
          <div class="md:hidden text-center mb-8">
            <div class={["inline-flex p-3 rounded-xl mb-4 text-white shadow-lg bg-gradient-to-br", @gradient_class]}>
