defmodule Mcp.Seeder do
  ...
  alias Mcp.Repo
  alias Mcp.Underwriting.{AgentBlueprint, BankSeeder, DemoSeeder}
  ...
  defp populate_tenant_permissions(tenant) do
    ...
    permissions = [
      # Admin permissions
      {"admin", "all", "special", "Full administrative access to all system features", true, true,
       5},

      # Customer management
      {"admin", "view_customers", "customers", "View customer information and details", true,
       true, 3},
      ...
      {"admin", "manage_customer_status", "customers", "Activate/deactivate customer accounts",
       true, false, 4},
      ...
      {"admin", "tenant_billing", "special", "Manage tenant billing and subscriptions", true,
       false, 5},
      ...
      {"admin", "manage_user_roles", "users", "Assign and manage user roles and permissions",
       true, false, 5},

      # System permissions
      {"admin", "view_system_settings", "system", "View system configuration and settings", true,
       true, 4},
      {"admin", "manage_system_settings", "system", "Modify system configuration and settings",
       true, false, 5},

      # Billing admin permissions
      {"billing_admin", "view_customers", "customers",
       "View customer information for billing purposes", true, true, 3},
      {"billing_admin", "view_customer_details", "customers",
       "View detailed customer information", true, false, 3},
      {"billing_admin", "view_billing", "billing", "View billing information and reports", true,
       true, 3},
      {"billing_admin", "manage_invoices", "billing", "Create and manage invoices", true, false,
       4},
      {"billing_admin", "manage_payments", "billing", "Process payments and refunds", true, false,
       4},
      {"billing_admin", "view_payment_history", "billing",
       "View payment history and transactions", true, false, 3},
      {"billing_admin", "manage_billing_settings", "billing", "Configure billing system settings",
       true, false, 4},
      {"billing_admin", "export_billing_data", "billing", "Export billing data and reports", true,
       false, 3},

      # Support admin permissions
      {"support_admin", "view_customers", "customers",
       "View customer information for support purposes", true, true, 3},
      {"support_admin", "view_customer_details", "customers",
       "View detailed customer information", true, false, 3},
      {"support_admin", "view_support_tickets", "support", "View support tickets and requests",
       true, true, 3},
      {"support_admin", "create_support_tickets", "support",
       "Create support tickets on behalf of customers", true, false, 3},
      {"support_admin", "update_support_tickets", "support", "Update and manage support tickets",
       true, false, 4},
      {"support_admin", "close_tickets", "support", "Close resolved support tickets", true, false,
       3},
      {"support_admin", "assign_tickets", "support", "Assign tickets to support agents", true,
       false, 4},
      {"support_admin", "view_support_reports", "support", "View support analytics and reports",
       true, false, 3},

      # Operator permissions
      {"operator", "view_customers", "customers", "View customer information", true, true, 3},
      {"operator", "view_customer_details", "customers", "View detailed customer information",
       true, false, 3},
      {"operator", "view_services", "services", "View service information and status", true, true,
       3},
      {"operator", "activate_services", "services", "Activate customer services", true, false, 4},
      {"operator", "deactivate_services", "services", "Deactivate customer services", true, false,
       4},
      {"operator", "view_service_usage", "services", "View service usage statistics", true, false,
       3},
      ...
      {"viewer", "view_customer_details", "customers", "View detailed customer information", true,
       false, 2},
      {"viewer", "view_services", "services", "View service information", true, false, 1},
      {"viewer", "view_service_usage", "services", "View service usage statistics", true, false,
       1},
    ...
    entries =
      Enum.map(permissions, fn {role, permission, category, description, is_granted, is_required,
                                level} ->
        %{
  ...
  defp seed_agent_blueprints(tenant) do
    ...
    agents = [
      %{
        ...
        base_prompt:
          "You are a senior commercial underwriter. Your goal is to assess the legitimacy and creditworthiness of a business. Analyze the provided application data, financial statements, and risk signals to make a funding decision.",
      ...
      %{
        ...
        base_prompt:
          "You are The Eye, an advanced OCR and document analysis engine. Your goal is to extract structured data from financial documents (PDFs, images) with 100% accuracy. Identify document types, extract key fields, and flag any signs of tampering.",
      ...
      %{
        ...
        base_prompt:
          "You are a forensic investigator specializing in fraud detection. Analyze the application context for inconsistencies, synthetic identity patterns, and network anomalies. Look for mismatched data, high-risk IP addresses, and known fraud patterns.",
      ...
      %{
        ...
        base_prompt:
          "You are the Agent Architect, an expert AI systems designer specializing in the MCP platform. Your goal is to help users design and configure new AI agents.
      ...
      %{
        ...
        base_prompt:
          "You are a Mortgage Underwriter. Your goal is to assess borrower risk for residential property loans.
      ...
      %{
        ...
        base_prompt:
          "You are an Auto Loan Underwriter. Your goal is to assess risk for vehicle financing.
      ...
      %{
        ...
        base_prompt:
          "You are a Rental Screening Agent. Your goal is to assess a tenant's eligibility for a lease.
