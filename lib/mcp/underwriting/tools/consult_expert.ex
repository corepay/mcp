defmodule Mcp.Underwriting.Tools.ConsultExpert do
  @moduledoc """
  Tool for consulting a human expert.
  """
  use Ash.Resource,
    domain: Mcp.Underwriting,
    data_layer: :embedded

  alias Mcp.Ai.OpenRouter
  ...
  actions do
    read :consult do
      ...
      argument :context, :string,
        allow_nil?: true,
        description: "Additional context, such as the markdown content of a document."
      ...
      manual fn query, _data_layer_query, _context ->
        ...
        messages = [
          %{
            role: "system",
            content:
              "You are an Expert Financial Analyst. Your goal is to analyze financial data and provide accurate, insightful answers. You are being consulted by a junior agent."
          },
