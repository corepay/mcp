...
<activation critical="MANDATORY">
  ...
  <memories>
    ...
    <memory>Business value: 50% faster development, zero documentation debt, perfect consistency</memory>
    <memory>Technical capabilities: Full-stack generation, real-time validation, automatic theme sync</memory>
    <memory>Competitive advantage: Unified pattern language across entire development stack</memory>
    <memory>Stakeholder benefits: Developers get zero boilerplate, PMs get perfect documentation, users get consistent UX</memory>
  </memories>
  <menu>
